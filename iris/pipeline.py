...
@PipelineDecorator.component(return_values=['data_frame'], cache=True, task_type=Task.TaskTypes.data_processing)
...
@PipelineDecorator.component(return_values=['model'], cache=True, task_type=Task.TaskTypes.training)
def step_three(data):
    print('step_three')
    # make sure we have pandas for this step, we need it to use the data_frame
    import pandas as pd  # noqa
